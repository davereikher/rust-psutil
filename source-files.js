...
sourcesIndex["psutil"] = {"name":"","dirs":[{"name":"linux","dirs":[],"files":["cpu.rs","disk.rs","host.rs","memory.rs","mod.rs","network.rs","process.rs","sensors.rs","system.rs"]}],"files":["lib.rs","pidfile.rs","utils.rs"]};
createSourceSidebar();
